...
struct IHandleEntity_vtable
{
	void * CTerrorPlayer_dtor1;
	void * CTerrorPlayer_dtor0;
	void * SetRefEHandle;
	void * GetRefEHandle;
};

struct IServerUnknown_vtable
{
	IHandleEntity_vtable IHandleEntity;
	void * GetCollideable;
	void * GetNetworkable;
	void * GetBaseEntity;
};

struct IServerEntity_vtable
{
	IServerUnknown_vtable IServerUnknown;
	void * GetModelIndex;
	void * GetModelName;
	void * SetModelIndex;
};
...
{
	IServerEntity_vtable IServerEntity;
	void * GetServerClass;
...
struct CBaseAnimating_vtable
{
	CBaseEntity_vtable CBaseEntity;
	void * GetIdealSpeed;
	void * GetIdealAccel;
...
{
	CBaseAnimating_vtable CBaseAnimating;
	void * SetViewtarget;
...
struct CBaseCombatCharacter_vtable
{
	...
	void * BodyDirection3D;
	void * HeadDirection2D;
	void * HeadDirection3D;
	void * EyeDirection2D;
	void * EyeDirection3D;
	void * IsHiddenByFog;
	void * IsHiddenByFog;
...
struct CBasePlayer_vtable
{
	CBaseCombatCharacter_vtable CBaseCombatCharacter;
...
struct CAI_ExpressorHost_CBasePlayer__vtable
{
	CBasePlayer_vtable CBasePlayer;
	void * NoteSpreaking;
	void * Speak;
	void * Speak2;
...
struct CBaseMultiplayerPlayer_vtable
{
	CAI_ExpressorHost_CBasePlayer__vtable CAI_ExpressorHost;
	void * SpeakIfAllowed;
...
struct CCSPlayer_vtable
{
	CBaseMultiplayerPlayer_vtable CBaseMultiplayerPlayer;
